...
(function () {
    angular
    	...
    	.controller("MapController", ['$scope', '$location', '$route', 'app', function ($scope, $location, $route, app) {
		    ...
		    // ];
		    // var taxiData2 = [
			   //  new google.maps.LatLng(37.762967, -115.415183),
		    //     new google.maps.LatLng(37.762278, -115.415127),
		    //     new google.maps.LatLng(37.761675, -115.415055),
		    //     new google.maps.LatLng(37.760932, -115.414988),
		    //     new google.maps.LatLng(37.759337, -115.414862),
		    //     new google.maps.LatLng(37.773187, -115.421922),
		    //     new google.maps.LatLng(37.773043, -122.422118),
		    //     new google.maps.LatLng(37.773007, -122.422165),
		    //     new google.maps.LatLng(37.772979, -122.422219),
		    //     new google.maps.LatLng(37.772865, -122.422394),
